...
# print(sys.platform) # Verifica o sistema operacional
...
# print(proc.args) # Comando e argumentos usados
# print(proc.stderr) # None, pois não capturamos erros
print(proc.stdout) # Saída do comando
# print(proc.returncode) # 0 se sucesso, outro valor se erro